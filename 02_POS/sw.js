...
const CACHE = 'gmt-pos--v20260728';
const PRECACHE = [
  '../_shared/gmt-core.js',
  '../_shared/gmt-staff.js',"./index-final.html", "./gmt-theme.css", "./logo.jpg", "./manifest.json", "./gmt-icon-192.png", "./gmt-icon-512.png", "./gmt-guide-pos.js"];
