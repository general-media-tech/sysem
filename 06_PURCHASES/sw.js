...
const CACHE = 'gmt-purch--v20260728';
const PRECACHE = [
  '../_shared/gmt-core.js',
  '../_shared/gmt-staff.js',"./purchases_standalone.html", "./gmt-training.js", "./gmt-theme.css", "./logo.jpg", "./manifest.json", "./gmt-icon-192.png", "./gmt-icon-512.png",];
